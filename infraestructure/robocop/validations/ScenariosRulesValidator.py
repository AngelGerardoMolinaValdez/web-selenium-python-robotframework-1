...
class ScenariosRulesValidator(BaseRulesValidator):
    def __init__(self, components_path, rules_path: str):
        self.components_path = components_path
        rules = {os.path.join(rules_path, "ScenariosRulesValidator.py")}
        super().__init__(rules)

    def _get_files(self):
        scenarios_glob_pattern = os.path.join(self.components_path, "**", "scenarios", "**", "*.resource")
